...
export default function Education() {
  return (
    <div id="education" className="max-w-5xl mx-auto px-6 py-20">
      ...
      <div className="grid md:grid-cols-2 gap-6 group/list">
        {education.map((edu, i) => (
          <AnimatedSection key={edu.school} delay={i * 0.15}>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 hover:border-blue-500/30 transition-all duration-300 h-full group">
              ...
              {edu.gpa && (
                <span className="inline-block mt-3 px-3 py-1 text-xs font-medium bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded-full">
                  GPA: {edu.gpa}
                </span>
              )}
            </div>
